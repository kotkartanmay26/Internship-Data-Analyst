...
with st.sidebar:
    ...
    ">
        ...
        <div>
            <h2 style="margin:0; font-size:19px; font-weight:800; color:white;">Puja Fluid Seals</h2>
            <p style="margin:6px 0 0 0; font-size:13px; color:#94A3B8; font-weight:600;">Pvt. Ltd.</p>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="padding:20px 8px 0 8px; border-top:1px solid rgba(255,255,255,0.1); margin-top:24px;">
        <p style="color:#64748B; font-size:12px; font-weight:800; text-transform:uppercase; letter-spacing:1.5px; margin:0 0 12px 0;">System</p>
        <div style="display:flex; align-items:center; gap:10px; padding:14px 16px; background:rgba(34,197,94,0.12); border:1px solid rgba(34,197,94,0.35); border-radius:12px; margin-bottom:16px;">
            <span style="width:12px; height:12px; border-radius:50%; background:#22C55E; box-shadow:0 0 0 4px rgba(34,197,94,0.25);"></span>
            <span style="font-size:14px; color:#86EFAC; font-weight:800;">All Systems Operational</span>
        </div>
        ...
        <div style="
            ...
            margin-bottom:16px;
        ">
            <p style="font-size:16px; font-weight:800; color:#60A5FA; margin:0 0 10px 0;">🚀 Boost Productivity</p>
            <p style="font-size:13px; color:rgba(255,255,255,0.75); line-height:1.6; margin:0 0 16px 0;">
                Track performance and make data-driven decisions effectively.
            </p>
        </div>
        ...
        <div style="
            ...
            font-weight:600;
        ">
            <p style="margin:0 0 4px 0;">© 2024 Puja Fluid Seals Pvt. Ltd.</p>
...
with header_col1:
    st.markdown("""
    <div>
        <h1 style="margin:0; font-size:clamp(28px, 3.5vw, 38px); font-weight:900; color:#0A2A66; letter-spacing:-0.5px;">
            Dashboard Overview
        </h1>
        <p style="margin:8px 0 0 0; font-size:16px; color:#64748B; font-weight:600;">
            Home • Overview
        </p>
    </div>
    """, unsafe_allow_html=True)
...
with header_col2:
    search_col, date_col, refresh_col, download_col, export_col, notif_col, profile_col = st.columns([2.2, 1.5, 1, 1, 1, 0.8, 0.8])
    ...
    with refresh_col:
        st.button("🔄 Refresh Data", key="refresh_header", use_container_width=True)
    
    with download_col:
        st.button("⬇️ Download Report", key="download_header", use_container_width=True)
    
    with export_col:
        st.button("📤 Export PDF", key="export_header", use_container_width=True)
    ...
    with profile_col:
        ...
        ">
            ...
            <div style="text-align:left;">
                <p style="margin:0; font-size:15px; font-weight:900; color:#0A2A66;">Admin</p>
                <p style="margin:2px 0 0 0; font-size:12px; color:#64748B; font-weight:600;">Administrator</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
...
if st.session_state.selected_page == "home":
    ...
    for col, kpi in zip([kpi_col1, kpi_col2, kpi_col3, kpi_col4, kpi_col5, kpi_col6], kpi_items):
        with col:
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-trend" style="color:{trend_color}; display:flex; align-items:center; gap:6px;">
                    <span style="font-size:15px; font-weight:900;">{trend_icon}</span>
        ...
        with st.container():
            ...
            for act in activities:
                ...
                ">
                    ...
                    <div style="flex:1;">
                        <p style="margin:0 0 6px 0; font-size:14px; color:#1E293B; font-weight:700;">{act['text']}</p>
    ...
    # Bottom Row: Skills, Training, Quick Actions
    ...
    with bottom_col1:
        with st.container():
            ...
            st.dataframe(
                skills_df,
                column_config={
                    "Average Level": st.column_config.ProgressColumn(
                        "Average Level",
                        format="%d%%",
                        min_value=0,
                        max_value=100,
            ...
            <div class="chart-card">
                ...
                <div style="display:flex; gap:20px; align-items:center;">
                    ...
                    ">
                        ...
                        ">
                            <span style="font-size:40px; font-weight:900; color:#0A2A66;">75%</span>
                            <span style="font-size:14px; color:#64748B; font-weight:700;">Completed</span>
                        </div>
                    </div>
                    <div style="flex:1;">
                        <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
                            <span style="font-size:14px; color:#475569; font-weight:700;">Total Trainings</span>
                            <span style="font-size:14px; color:#0A2A66; font-weight:900;">40</span>
                        </div>
                        <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
                            <span style="font-size:14px; color:#475569; font-weight:700;">Completed</span>
                            <span style="font-size:14px; color:#22C55E; font-weight:900;">30</span>
                        </div>
                        <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
                            <span style="font-size:14px; color:#475569; font-weight:700;">In Progress</span>
                            <span style="font-size:14px; color:#F97316; font-weight:900;">8</span>
                        </div>
                        <div style="display:flex; justify-content:space-between;">
                            <span style="font-size:14px; color:#475569; font-weight:700;">Pending</span>
                            <span style="font-size:14px; color:#EF4444; font-weight:900;">2</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    with bottom_col3:
        with st.container():
            ...
            with quick_col1:
                st.markdown("""
                <div class="quick-action-card" style="margin-bottom:16px;">
    ...
    ">
        ...
        <div style="display:flex; align-items:center; gap:12px;">
            <span style="color:#64748B; font-size:14px; font-weight:600;">Auto refresh every 5 minutes</span>
            <div style="
                width:50px;
                height:28px;
                ...
                padding:3px;
            ">
                <div style="width:22px; height:22px; background:white; border-radius:50%; margin-left:auto;"></div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
elif st.session_state.selected_page in ["efficiency", "skills", "stock", "production", "toolroom", "profit", "training", "departments", "reports"]:
    page_titles = {
        "efficiency": "📈 Employee Efficiency",
        "skills": "🎯 Skill Matrix",
        "stock": "📦 Stock Analysis",
